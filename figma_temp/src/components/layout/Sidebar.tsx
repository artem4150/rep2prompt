...
import { Home, Files, GitBranch, Sliders, GitCompare, Package, Users, Settings, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'exports', label: 'Экспорты', icon: Files },
  { id: 'profiles', label: 'Профили', icon: Sliders },
  { id: 'compare', label: 'Сравнение', icon: GitCompare },
  { id: 'dependencies', label: 'Зависимости', icon: Package },
  { id: 'workspaces', label: 'Команды', icon: Users },
];
